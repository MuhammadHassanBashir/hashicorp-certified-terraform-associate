...
- **terraform state list:**  This command is used to list resources within a Terraform state file.
- **terraform  state show:** This command is used to show the attributes of a single resource in the Terraform state file.
```t
